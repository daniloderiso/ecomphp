			...
			<?php if(isset($smsg)){ ?><div class="alert alert-success" role="alert"> <?php echo $smsg; ?> </div><?php } ?>
					<div class="row">
						...
						<div class="col-md-7 product-single">
							...
							<div class="p-price">EUR <?php echo $prodr['price']; ?>.00/-</div>
					...
					<div class="clearfix space30"></div>
							...
							<form method="get" action="addtowishlistwithnames.php">
							<div class="shop-btn-wrap">
								<input type="submit" class="button btn-small" value="Add to Wishlist">
							</div>
							...
							<input type="hidden" name="listid" value="<?php echo $prodr['id']; ?>">
							 ...
							 ?>
								<div class="sm-item isotope-item">
									<div class="product">
										...
										<div class="product-price">EUR <?php echo $relr['price']; ?>.00/-<span></span></div>
									</div>
								</div>
							<?php } ?>
							</div>
