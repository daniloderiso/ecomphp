			<div class="menu-wrap">
				...
				$cart = $_SESSION['cart']; ?>				<!-- DANILO 20200205 -->

					<div class="s-cart">
						<?php
						if(isset($_SESSION['cart']) & !empty($_SESSION['cart'])) {?>
						<div class="sc-ico"><i class="fa fa-shopping-cart"></i>
						<em> 
						...
						if(isset($_SESSION['cart']) & !empty($_SESSION['cart'])) 
							...
							<div class="ci-item">
								...
								<div class="ci-item-info">
									...
									<p><?php echo $value['quantity']; ?> x EUR <?php echo $navcartr['price']; ?>.00/-</p>
									<div class="ci-edit">
							...
							<div class="ci-total">Subtotal: EUR <?php echo $total; ?>.00/-</div>
							<div class="cart-btn">
