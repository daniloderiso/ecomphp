	...
	<section id="content">
		<div class="content-blog content-account">
			...
			<table class="cart-table account-table table table-bordered">
				...
				<?php
					$wishsql = "SELECT p.name, p.price, p.id AS pid, w.id AS id, w.`timestamp`, w.nome AS nome FROM wishlistname w JOIN products p WHERE w.pid=p.id AND w.uid='$uid' ORDER BY nome";
